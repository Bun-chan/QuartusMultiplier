...
create_clock -name {vir_clock} -period 10.000 -waveform { 0.000 5.000 } 
...
set_clock_uncertainty -rise_from [get_clocks {vir_clock}] -rise_to [get_clocks {clk1}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {vir_clock}] -fall_to [get_clocks {clk1}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {vir_clock}] -rise_to [get_clocks {clk1}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {vir_clock}] -fall_to [get_clocks {clk1}]  0.020  
